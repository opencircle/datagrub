  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {promptsLoading ? (
          <div className="text-center py-8 text-gray-600">Loading prompts...</div>
        ) : prompts.length === 0 ? (
          <div className="text-center py-16 bg-gray-50 rounded-2xl">
            <FileText className="h-16 w-16 text-gray-400 mx-auto mb-4" />
            <p className="text-gray-600 mb-6 text-lg">No prompts in this project yet</p>
            <button
              onClick={() => setIsPromptBuilderOpen(true)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {prompts.map((prompt) => (
              <div
                key={prompt.id}
                className="bg-white border border-gray-200 rounded-xl p-5 hover:border-gray-900 hover:shadow-md transition-all cursor-pointer"
              ...
              >
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 text-sm text-gray-900 hover:text-gray-700 font-medium py-2 px-3 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-1.5"
                  >
