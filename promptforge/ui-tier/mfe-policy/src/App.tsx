...
const CategoryBadge: React.FC<{ category: PolicyRule['category'] }> = ({ category }) => {
  const config = {
    ...
    quality: { bg: 'bg-gray-100', text: 'text-gray-800', icon: Settings },
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Define and enforce AI governance rules</p>
        </div>
            ...
            {policies.map((policy, index) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <button className="ml-4 p-2 hover:bg-gray-100 rounded-md transition-colors">
            ...
            {violations.map((violation, index) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-semibold text-gray-900">{violation.ruleName}</h3>
                    ...
                    <p className="text-sm text-gray-900 mb-2">{violation.description}</p>
                    <div className="flex items-center gap-4 text-xs text-gray-500">
